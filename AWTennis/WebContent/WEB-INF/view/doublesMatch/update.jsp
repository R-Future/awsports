...
<div class="content-wrapper">
	...
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
        ...
        <li><a href="<%=request.getContextPath()%>/event/detail?id=${doublesMatch.eventid}">活动详细</a></li>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<form class="form" action="<%=request.getContextPath()%>/doublesMatch/save" method="post">
				<input type="hidden" name="id" id="id" value="${doublesMatch.id}" class="form-control"/>
				<input type="hidden" name="eventid" id="eventid" value="${doublesMatch.eventid}" class="form-control"/>
				
				<div class="form-group">
					<label for="type">比赛类型</label>
					<input type="text" name="type" id="type"  value="doublesmatch" disabled class="form-control"/>
				</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<select id="homeid" name="homeid" class="form-control select-chosen">
								...
								<c:forEach items="${ teams }" var="team">
									<c:choose>
										<c:when test="${ doublesMatch.homeid.equals(team.userid) }">
											<option value="${ team.userid }" selected>${ team.username }</option>
										</c:when>
										<c:otherwise>
						...
						<div class="col-md-6">
							...
							<select id="guestid" name="guestid" class="form-control select-chosen">
								...
								<c:forEach items="${ teams }" var="team">
									<c:choose>
										<c:when test="${ doublesMatch.guestid.equals(team.userid) }">
											<option value="${ team.userid }" selected>${ team.username }</option>
										</c:when>
										<c:otherwise>
											<option value="${ team.userid }">${ team.username }</option>
				...
				<div class="form-group">
					...
					<input type="text" id="score" name="score" value="${ doublesMatch.score }" class="form-control">
				</div>
				...
				<div class="form-group">
					<div class='row'>
						<div class="col-md-6">
							...
							<c:choose>
								<c:when test="${ doublesMatch.ishomeretired }">
						...
						<div class="col-md-6">
							...
							<c:choose>
								<c:when test="${ doublesMatch.isguestretired }">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-md-6">
							...
							<input type="number" name="homepoint" id="homepoint" value="${doublesMatch.homepoint}"  min="0" class="form-control"/>
						</div>
						<div class="col-md-6">
							<label for="guestpoint">客场得分</label>
							<input type="number" name="guestpoint" id="guestpoint" value="${doublesMatch.guestpoint}" min="0" class="form-control"/>
						</div>
					</div>
				</div>
					...
					<div class='row'>
						<div class="col-md-6">
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${ doublesMatch.ishomewin }">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<c:choose>
									<c:when test="${ doublesMatch.invalid }">
				...
				<div class="form-group">
					...
					<input type="text" name="note" id="note" value="${doublesMatch.note}" class="form-control"/>
				</div>
