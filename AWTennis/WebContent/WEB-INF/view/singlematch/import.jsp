...
<div class="content-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<form class="form" action="<%=request.getContextPath()%>/singlematch/importFromExcel" enctype="multipart/form-data" method="post">
				<div class="form-group">
					<input type="file" name="file" class=""/>
				</div>
				<button type="submit" id="submit" class="btn btn-danger" onclick="return confirm('您确定导入吗?')">批量导入</button>
			</form>
			<a href="<%=request.getContextPath()%>/file/downloadSingleDoc" class="">下载excel模板</a>
		</div>
	</div>
	</section>
</div>
