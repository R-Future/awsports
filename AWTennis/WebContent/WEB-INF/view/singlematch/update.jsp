		...
		<div class="row">
			<form class="form" action="<%=request.getContextPath()%>/singlematch/saveOld" method="post">
				...
				<div class="form-group">
			 	...
			 	<div class="form-group">
					<label for="isQualification"> 是否资格赛(<i style="color:red">用于计算资格赛积分，非常重要！！！</i>):</label>
					<c:choose>
						<c:when test="${ !singlematchQuery.singlematch.isqualification }">
							<input type="radio" name="singlematch.isqualification" id="isNotQualification" value="false" checked/>不是
							<input type="radio" name="singlematch.isqualification" id="isQualification" value="true"/>是
						</c:when>
						<c:otherwise>
							<input type="radio" name="singlematch.isqualification" id="isNotQualification" value="false"/>不是
							<input type="radio" name="singlematch.isqualification" id="isQualification" value="true" checked/>是
						</c:otherwise>
					</c:choose>
				</div>
