...
<div class="content-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="" style="color:red">
			...
			<c:out value="${ teamExisted }" default=""/>
			<br/>
		</div>
		...
		<form class="form" action="<%=request.getContextPath()%>/team/save" method="post">
			...
			<div class="form-group">
				...
				<select name="user1id" id="user1" class="form-control select-chosen">
			...
			<div class="form-group">
				...
				<select name="user2id" id="user2" class="form-control select-chosen">
					<option value="0">--请选择--</option>
					<c:forEach items="${ userQuerys }" var="userQuery">
						<c:choose>
...
// 		startDate:date,
	...
	/* verify user1 */
	$("#user1").siblings("#user1_chosen").click(function(){
		var user = Number($("#user1").find("option:selected").val());
		var partner = Number($("#user2").find("option:selected").val());
		var parent = $("#user1").parent();
		var error = $("#user1").siblings("span");
		if(user === 0){
	...
	/* verify user2 */
	$("#user2").siblings("#user2_chosen").click(function(){
		var user = Number($("#user2").find("option:selected").val());
		var partner = Number($("#user1").find("option:selected").val());
		var parent = $("#user2").parent();
		var error = $("#user2").siblings("span");
		if(user === 0){
			parent.addClass("has-error");
			error.html("请选择队友");
		}else{
