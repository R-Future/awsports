...
--
-- Table structure for table `aw_singlematchscore`
--

DROP TABLE IF EXISTS `aw_singlematchscore`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aw_singlematchscore` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `sm_matchID` (`matchId`),
  CONSTRAINT `sm_matchID` FOREIGN KEY (`matchId`) REFERENCES `aw_singlematch` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='单打比赛比分记录表';
