...
--
-- Table structure for table `aw_teamrank`
--

DROP TABLE IF EXISTS `aw_teamrank`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aw_teamrank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `teamId` int(11) NOT NULL COMMENT '选手ID',
  `entry` int(11) NOT NULL COMMENT '参赛项目',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `index_tr_teamID` (`teamId`),
  KEY `index_tr_entry` (`entry`),
  KEY `index_tr_year` (`year`),
  KEY `index_tr_week` (`week`),
  CONSTRAINT `tr_teamID` FOREIGN KEY (`teamId`) REFERENCES `aw_team` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='赛季组合排名表';
