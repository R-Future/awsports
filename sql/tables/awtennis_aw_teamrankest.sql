...
--
-- Table structure for table `aw_teamrankest`
--

DROP TABLE IF EXISTS `aw_teamrankest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aw_teamrankest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `trEST_teamID` (`teamId`),
  CONSTRAINT `trEST_teamID` FOREIGN KEY (`teamId`) REFERENCES `aw_team` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='组合排名‘最’记录表';
